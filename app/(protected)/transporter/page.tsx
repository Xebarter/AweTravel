            ...
            <CardContent className="pt-6">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-foreground">{formatCurrency(1_400_000)}</p>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={revenueData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Bar yAxisId="left" dataKey="revenue" fill="#3b82f6" name={`Revenue (${APP_CURRENCY_CODE})`} />
            ...
            <CardContent className="space-y-3">
              ...
              <div className="p-3 bg-accent/10 border border-accent/20 rounded-lg flex gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-muted-foreground text-xs mt-1">{formatCurrency(35000)} received from 7 bookings</p>
                </div>
              </div>
            </CardContent>
          </Card>
